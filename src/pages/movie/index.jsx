...
export default () => {
    ...
    return (
        <main className="w-full flex-1 p-4 xs:p-8">
            <div
                style={{ backgroundImage: `url(${getUrlPoster(movie?.backdrop_path)})` }}
                className="movie-info w-full bg-none bg-cover" >
                <div className="w-full h-full bg-movie-gradient-dark sm:p8 flex flex-col items-center lg:flex-row gap-8">
